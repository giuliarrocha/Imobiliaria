        ...
        <div class="col" style="background-color: #DFDFC9;">
          ...
          <div class="card w-75" style="margin-left: 140px; margin-bottom: 35px;">
            <div class="card-body">
                ...
                <div class="row">
                  <a class="btn text-white w-50" style="background-color: #A55C55; margin-top: 50px; margin-left: 150px;" href="" role="button">Cadastrar Novo Cliente</a>
                </div>
            </div>
        </div>
              ...
              <div class="card-body">
                  <table class="table table-bordered">
                      <thead>
                        ...
                        <tbody>
                          <tr>
                            <td>123.689.486-16</td>
                            <td>Artur Kyung Min Lee</td>
                            <td>M</td>
                            <td>20/05/1989</td>
                            <td>14/06/2021</td>
                            <td>arturzinho@gmail.com</td>
                            <td>
                                <div class="row">
                                      <div class="col">
