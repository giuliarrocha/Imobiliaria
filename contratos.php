          ...
          <form action="" method="post">
            <div class="card-body">
                    ...
                    <div class="col">
                        ...
                        <select class="form-select" aria-label="Default select example" name="consulta">
                            <option selected value="0">Todos os campos</option>
                                ...
                                <option value="2">Data Inicial</option>
                                <option value="3">Data Final</option>
                                <option value="4">Código Imóvel</option>
                        </select>
                    </div>
                    <div class="col">
                                ...
                                <select class="form-select" aria-label="Default select example" name="ordenar">
                                        ...
                                        <option value="1">Data de Início</option>
                                        <option value="2">CPF Corretor</option>
                                        <option value="3">CPF Cliente</option>
                                        <option value="4">CPF Proprietário</option>
                                        <option value="5">Código Imóvel</option>
                                </select>
                    </div>
                </div>
                ...
                <div class="row">
                  ...
                  <a class="btn text-white w-50" style="background-color: #A55C55; margin-top: 25px; margin-left: 150px;" href="cadastro_contrato.php" role="button">Cadastrar Novo Contrato</a>
                </div>
            </div>
            </form>
        </div>
                          ...
                          <?php
                            ...
                            switch($qual) {
                                case '0':
                                    ...
                                    break;
                                case '1':
                                    $query.=" ORDER BY dataInicio;";
                                    break;
                                case '2':
                                    $query.=" ORDER BY cpfCorretor;";
                                    break;
                                case '3':
                                    $query.=" ORDER BY cpfCliente;";
                                    break;
                                case '4':
                                    $query.=" ORDER BY cpfProprietario;";
                                    break;
                                case '5':
                                    $query.=" ORDER BY codigoImovel;";
                                    break;
                                default:
                                    break;
                            }
                            ...
                            <tr>
                              ...
                              <td>'.$row['valorAluguel'].'</td>
                              <td>'.$row['cpfCorretor'].'</td>
                              <td>'.$row['cpfCliente'].'</td>
                              <td>'.$row['cpfProprietario'].'</td>
                              <td>'.$row['codigoImovel'].'</td>
                              <td>
                                  <div class="row">
                                        <div class="col">
                                            <a href="pagina_contrato_editar.php?codigo='.$row['codigo'].'" style="color: #A55C55;">
                                        ...
                                        <div class="col" >
                                            <a href="back-end/excluir_contrato.php?codigo='.$row['codigo'].'" style="color: #A55C55;">
