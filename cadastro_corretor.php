    ...
    <div class="container-fluid h-100">
      <div class="row h-100">
        ...
        <div class="col" style="background-color: #DFDFC9;">
          ...
          <form action="back-end/add_corretor.php" method="post">
          <div class="card text-center">
              <div class="card-body">
                  ...
                  <div class="col text-start w-100">
                    <input type="dataContratacao" class="form-control" name="inputDataContratacao" id="inputDataContratacao" placeholder="00/00/0000">
                  </div>
              ...
              <div class="mb-3 row">
                ...
                <div class="col">   
                  <input type="salario" class="col-sm-1 form-control" name="inputsalario" id="inputsalario" placeholder="Exemplo: 1253,22">
                </div>
            </div>
