    ...
    <div class="container-fluid h-100">
      <div class="row h-100">
        <div class="col-3" style="background-color: #063647; size: 20px;">
          ...
          <a class="btn text-dark" style="background-color: #DBA67B; margin-top: 30px; margin-left: 100px;" href="clientes.php" role="button">
          ...
          <div class="card text-center">
              <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                          <input type="CPF" class="form-control" id="inputCPF" name="inputCPF" placeholder="Digite o CPF" required>
                        </div>
                    </div>
