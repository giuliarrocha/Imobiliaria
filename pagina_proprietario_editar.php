        ...
        <div class="col" style="background-color: #DFDFC9;">
          ...
          <div class="card text-center">
              <div class="card-body">
                        ...
                        $query = "SELECT * FROM telefoneproprietario WHERE cpfCorretor = '$cpf'";
                        ...
                        while($row1 = mysqli_fetch_array($result1)) {
                            ...
                            <div class="mb-3 row">
                                <label for="inputTelefone" class="col-sm-2 col-form-label text-start">Telefone:</label>
                                    <div class="col-sm-5">   
                                    <input type="text" class="col-sm-1 form-control" placeholder="Ex: (18) 98745-9633" value="'.$row1['numero'].'">
                                    </div>
                            </div>';
                        }
